...
export interface Expression<T> extends OperationNodeSource {
   ...
   * Simple add this getter for your expression and always return `undefined` from it:
   *
   * ```ts
   ...
   *
   * If you are creating your own extension, it's often easiest to use the {@link sql}
