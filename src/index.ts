...
export * from './dialect/sqlite/sqlite-type-config.js'
...
export * from './dialect/mysql/mysql-type-config.js'
...
export * from './dialect/postgres/postgres-type-config.js'
