...
Kysely offers a CLI you can use for migrations. To install it, run the following in your terminal:
...
You can create migration files using the CLI by running:

```bash
kysely migrate make <migration_name>
```
