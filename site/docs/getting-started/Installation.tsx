...
const packageManagers: PackageManagerDetails[] = [
  ...
  },
  {
    ...
    description: (
      <>
        ...
        .
        <br />
        Your project is using {PRETTY_PACKAGE_MANAGER_NAMES['pnpm']} if it has 
  ...
  },
  {
    ...
    description: (
      <>
        <Link to="https://yarnpkg.com">{PRETTY_PACKAGE_MANAGER_NAMES['yarn']}</Link> 
        {' '}is a fast, reliable and secure dependency manager for <NodeJSLink />
        .
        <br />
        Your project is using {PRETTY_PACKAGE_MANAGER_NAMES['yarn']} if it has 
  ...
  },
  {
    ...
    description: (
      <>
        <Link to="https://deno.com/runtime">{PRETTY_PACKAGE_MANAGER_NAMES['deno']}</Link> 
        {' '}is a secure runtime for <JavaScriptLink /> and <Link to="https://www.typescriptlang.org">TypeScript</Link>
        .
      </>
    ),
    command: {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        bundler, transpiler, test runner, and {PRETTY_PACKAGE_MANAGER_NAMES['npm']}
...
export function Installation() {
  return <>
    <p>Kysely can be installed using any of the following package managers:</p>
    ...
    <Tabs queryString="package-manager">
      {packageManagers.map(({ command, value, ...packageManager }) => (
        ...
        <TabItem key={value} value={value} label={PRETTY_PACKAGE_MANAGER_NAMES[value]}>
          <p>{packageManager.description}</p>
          <p><strong>{command.intro}</strong></p>
