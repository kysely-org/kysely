...
export const quotes: QuoteProps[] = [
  ...
  {
    authorName: 'Miroslav "Yamiteru" Vršecký',
    authorTitle: 'Spectoda Lead SWE & Tech Lead',
    avatar: 'yamiteru',
    date: 'Apr 2026',
    link: 'https://x.com/the_yamiteru/status/2048298019603321242',
    text: "Since then I've slowly migrated over to Kysely and I couldn't be happier. Yes it's harder because it's only a query builder but a very type-safe one. You have to write migrations as TypeScript files which I absolutely love and now with the help of AIs it's a breeze.",
  },
  {
  ...
  {
    authorName: 'Casey Collins',
    authorTitle: 'HubSpot Director of Engineering',
    avatar: 'casey',
    date: 'May 2026',
    link: 'https://x.com/itisthecase/status/2059263962315657689',
    text: 'Its so good that I had to learn how to spell it correctly',
  },
  {
